  ...
  const [reviews, setReviews] = useState([
    {
      ...
      rating: 5,
      text: "GShare Server is amazing! Lightning-fast streaming with no buffering. Highly recommended!",
    },
  ])
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="GShare Server-api">GShare Server API</option>
