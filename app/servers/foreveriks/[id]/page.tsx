  ...
  const [reviews, setReviews] = useState([
    {
      ...
      rating: 5,
      text: "Forever IKS is amazing! Lightning-fast streaming with no buffering. Highly recommended!",
    },
  ])
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Forever IKS-api">Forever IKS API</option>
