  ...
  const [reviews, setReviews] = useState([
    {
      ...
      rating: 5,
      text: "Apollo + Forever is amazing! Lightning-fast streaming with no buffering. Highly recommended!",
    },
  ])
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Apollo + Forever-api">Apollo + Forever API</option>
