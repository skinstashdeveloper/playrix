  ...
  const [reviews, setReviews] = useState([
    {
      ...
      rating: 5,
      text: "Vip Recharge is amazing! Lightning-fast streaming with no buffering. Highly recommended!",
    },
  ])
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Vip Recharge-api">Vip Recharge API</option>
