// main website -> iptv -> starshare -> page.tsx
      ...
      <main className="min-h-screen bg-background">
        ...
        <section className="relative overflow-hidden py-16 md:py-20 bg-gradient-to-br from-primary/10 via-background to-secondary/10">
          <div className="max-w-7xl mx-auto text-center mb-16">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6">STARSHARE IPTV Plans</h1>
            <p className="text-lg text-foreground/60 max-w-2xl mx-auto">
              Experience unlimited entertainment with our premium IPTV subscription plans. 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4 md:px-0 max-w-7xl mx-auto">
            {plans.map((plan) => (
              <Link key={plan.id} href={`/iptv/starshare/${plan.id}`}>
                <div
