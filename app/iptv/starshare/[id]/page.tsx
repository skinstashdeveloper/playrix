// main website -> iptv -> starshare -> [id] -> page.tsx
  ...
  const [reviews, setReviews] = useState([
    {
      ...
      rating: 5,
      text: "STARSHARE is amazing! Lightning-fast streaming with no buffering. Highly recommended!",
    },
  ])
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="5glive-api">STARSHARE API</option>
