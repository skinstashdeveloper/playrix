...
export default function mgcamDashboardPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      alert("✅ MGcam plans updated successfully!")
    } catch (err) {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] w-full bg-background p-6 md:p-8 lg:p-10">
      <div className="mb-8 flex flex-col gap-2">
        <h1 className="text-2xl md:text-3xl font-bold text-foreground">MGcam Plans Editor</h1>
        <p className="text-sm md:text-base text-muted-foreground max-w-2xl">
          Edit all MGcam plans. Select a plan and modify its details.
        </p>
      </div>
